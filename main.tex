...
As mentioned in Section \ref{sec:introduction}, the execution of functions is performed in isolate sandboxes. Based on the status of the containers, two types of startups are defined:
